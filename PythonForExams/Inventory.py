...
class Inventory:
    ...
    def add_item(self,item_id,item_name,stock_count,price):
        self.inventory[item_id]={'Item Name':item_name,'Stock Count':stock_count,'Price':price}
    def update_item(self,item_id,stock_count,price):
        if item_id in self.inventory:
           self.inventory[item_id]['Stock Count']=stock_count
    ...
    def check_item_details(self, item_id):
        if item_id in self.inventory:
           ...
           return f"Product Name: {item['Item Name']}, Stock Count: {item['Stock Count']}, Price: {item['Price']}"
        else:
