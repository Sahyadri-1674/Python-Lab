...
class Restaurant:
    ...
    def book_tables(self,tableNo):
        self.book_table.append(tableNo)
    def customer_order(self,tableNo,item):
        order={'Table':tableNo,'Item':item}
    ...
    def print_customer_orders(self):
        for order in self.customer_orders:
            print("Table {}:{}".format(order['Table'],order['Item']))
